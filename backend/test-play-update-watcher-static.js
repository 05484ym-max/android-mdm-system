...
assert.match(packageGuard, /changedPackage == activeSession\.targetPackage/);
assert.match(packageGuard, /PlayStoreGate\.completeBecauseTargetInstalled\(appContext, changedPackage\)/);
