...
# ---- Admin panel: unified card + subscription unblock UI ----
...
"function openDeviceDetail(deviceId) {\n  currentDetailDeviceId = deviceId;\n  window.__currentDetailDeviceId = deviceId;\n",
'admin detail expose')
replace_once('admin-panel/index.html',
"function closeDeviceDetail() {\n  currentDetailDeviceId = null;\n",
"function closeDeviceDetail() {\n  currentDetailDeviceId = null;\n  window.__currentDetailDeviceId = null;\n",
'admin detail clear')
replace_once('admin-panel/index.html',
...
s = p.read_text().replace('window.allDevices', 'window.__allDevices')
p.write_text(s)
p = Path('admin-panel/subscription-unblock.js')
s = p.read_text().replace('window.currentDetailDeviceId', 'window.__currentDetailDeviceId')
p.write_text(s)
